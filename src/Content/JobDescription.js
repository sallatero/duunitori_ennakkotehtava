...
export const ToggleLinkButton = (props) => {
  ...
  if (props.allText) {
    return (
      <div className='toggle-link-button' onClick={() => props.setAllText(false)}>Read less</div>
    )
  } else {
    return (
      <div className='toggle-link-button' onClick={() => props.setAllText(true)}>Read more</div>
    )
  }
}
...
const JobDescription = (props) => {
  ...
  return (
    ...
    <ToggleLinkButton setAllText={setAllText}/>
  </div>
  )
}
